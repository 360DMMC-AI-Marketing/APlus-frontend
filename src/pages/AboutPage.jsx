  ...
  const founders = [
    {
      ...
      linkedin: "#",
      email: "aabellera@aplusmeddepot.com",
    },
    {
      name: "Louie",
      title: "Co-Founder",
      ...
      linkedin: "#",
      email: "louiem@aplusmeddepot.com",
    },
  ];
  ...
  const values = [
    {
      ...
      title: "Quality First",
      description:
        "Every product on our platform is vetted and certified. We work only with verified vendors who meet our strict quality standards.",
    },
    {
      icon: Heart,
      title: "Healthcare Focused",
      description:
        "We exist to serve healthcare professionals. Every decision we make puts patient safety and care quality at the center.",
    },
    {
      icon: Truck,
      title: "Reliable Delivery",
      description:
        "Medical supplies can't wait. We've built our logistics network to ensure fast, dependable delivery when it matters most.",
    },
    {
      icon: Users,
      title: "Trusted Partnerships",
      description:
        "From vendors to buyers, we build long-term relationships based on transparency, fairness, and mutual growth.",
    },
  ];
      ...
      <section className="bg-secondary-50 py-20 px-4">
        <div className="max-w-4xl mx-auto text-center animate-fade-in">
          ...
          <p className="text-xl text-gray-500 max-w-2xl mx-auto leading-relaxed">
            APlusMedDepot was founded with one goal: make it effortless for
            healthcare facilities to access the certified medical supplies they
            need — from trusted vendors, delivered fast.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="animate-slide-up">
              <h2 className="font-display text-4xl text-neutral mb-6">
                Our Mission
              </h2>
              <p className="text-gray-600 text-lg leading-relaxed mb-6">
                We set out to solve a real problem in healthcare procurement:
                too much friction, too little transparency, and too few
                trustworthy sources for medical supplies.
              </p>
              <p className="text-gray-600 leading-relaxed mb-6">
                APlusMedDepot is a multi-vendor marketplace that connects
                certified medical suppliers with hospitals, clinics, pharmacies,
                and individual healthcare professionals — all in one place, with
                confidence.
              </p>
              <p className="text-gray-600 leading-relaxed">
                Whether you're stocking an ER or running a family practice, we
                  ...
                  {[
                    {
                      ...
                      desc: "Designed from the ground up for clinics, hospitals, and healthcare professionals.",
                    },
                    {
                      icon: "✅",
                      title: "Verified Vendors Only",
                      desc: "Every supplier on our platform is reviewed and approved before listing products.",
                    },
                    {
                      icon: "🚀",
                      title: "Just Getting Started",
                      desc: "We're a new company with big ambitions. Early clients get the best rates and direct founder support.",
                    },
                  ].map((item) => (
                    <div
                      key={item.title}
      ...
      <section className="bg-gradient-to-b from-gray-50 to-white py-20 px-4">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            <h2 className="font-display text-4xl text-neutral mb-4">
              Meet the Founders
            </h2>
            <p className="text-gray-500 text-lg">
              Two entrepreneurs united by a shared belief that healthcare
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            {founders.map((founder) => (
              <div
                key={founder.name}
                className="glass-card p-8 animate-slide-up group hover:shadow-xl transition-shadow duration-300"
              >
                {/* Avatar */}
                <div
                ...
                <h3 className="font-display text-2xl text-neutral mb-1">
                  {founder.name}
                </h3>
            ...
            {values.map((value, i) => (
              ...
              >
                <div
                  ...
                  style={{
                    backgroundColor: i % 2 === 0 ? "#F03C3C" : "#002850",
                  }}
                >
