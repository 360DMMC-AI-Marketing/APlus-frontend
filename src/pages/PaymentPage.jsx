      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 flex items-center justify-center gap-2">
            <Lock className="w-4 h-4" /> Your payment information is encrypted
            and secure
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white border-2 border-gray-200 rounded-2xl p-6">
              <div className="mb-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  >
                    <CreditCard
                      className={`w-8 h-8 ${paymentMethod === "stripe" ? "text-primary" : "text-gray-400"}`}
                    />
                    <span
                      className={`text-sm font-semibold ${paymentMethod === "stripe" ? "text-primary" : "text-gray-600"}`}
                    >
                      Credit / Debit
                    </span>
                  ...
                  >
                    <svg
                      className={`w-8 h-8 ${paymentMethod === "paypal" ? "text-primary" : "text-gray-400"}`}
                      viewBox="0 0 24 24"
                      fill="currentColor"
                    >
                    ...
                    <span
                      className={`text-sm font-semibold ${paymentMethod === "paypal" ? "text-primary" : "text-gray-600"}`}
                    >
                      PayPal
                    </span>
                  ...
                  >
                    <svg
                      className={`w-8 h-8 ${paymentMethod === "net30" ? "text-primary" : "text-gray-400"}`}
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                    ...
                    <span
                      className={`text-sm font-semibold ${paymentMethod === "net30" ? "text-primary" : "text-gray-600"}`}
                    >
                      Net 30
                    </span>
                ...
                {!net30Eligible && (
                  <p className="mt-2 text-xs text-gray-500">
                    Net 30 requires Tax ID. Please update your profile or
                    contact support.
                  </p>
                )}
              </div>
              ...
              {paymentMethod === "paypal" && (
                <div className="space-y-4">
                  ...
                  <p className="text-xs text-gray-500 text-center">
                    By continuing, you'll be redirected to PayPal to log in and
                  ...
                  <div className="bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-200 rounded-xl p-6">
                    <div className="flex items-start gap-3 mb-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-700 mb-3">
                          Pay within 30 days of invoice date. Perfect for
                          healthcare organizations with established procurement
                          processes.
                        </p>
                      </div>
                    </div>
                      ...
                      <div className="pt-3 border-t border-gray-200">
                        ...
                        <div className="flex justify-between items-center text-sm">
                          ...
                          <span className="font-semibold text-green-600">
                            ${(creditInfo.available - finalTotal).toFixed(2)}
                          </span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                      ...
                      <ul className="text-xs text-gray-700 space-y-1">
                        ...
                        <li>
                          • Invoice will be sent to your registered email within
                          24 hours
                        </li>
                      </ul>
                    </div>
                    ...
                    <p className="text-xs text-gray-500 mt-3 text-center">
                      By placing this order, you agree to pay the invoice amount
                      within 30 days of the invoice date. Your order will be
                      processed immediately and shipped according to standard
                      delivery times.
                    </p>
                  </div>
                </div>
          ...
          <div className="lg:col-span-1">
            <div className="bg-gray-50 border-2 border-gray-200 rounded-2xl p-6 sticky top-24">
              <h2 className="font-semibold text-lg text-secondary mb-4">
                Order Summary
              </h2>
              ...
              <div className="mt-6 p-3 bg-green-50 border border-green-200 rounded-lg flex items-start gap-2">
                ...
                <div className="text-xs text-green-700">
                  ...
                  <p>
                    If you're not satisfied, we'll refund your purchase within
                    30 days.
                  </p>
                </div>
              </div>
