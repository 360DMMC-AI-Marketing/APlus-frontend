...
const HomePage = () => {
  ...
  const features = [
    {
      ...
      description:
        "All products meet strict medical standards and certifications",
    },
    {
      icon: Truck,
      title: "Fast Delivery",
    ...
    },
    {
      ...
      title: "24/7 Support",
      description:
        "Round-the-clock customer service for healthcare professionals",
    },
    {
      icon: Star,
  ...
  const categoryImageMap = {
    ...
    "Nursing Care Supplies":
      "https://i.ibb.co.com/0RfXrX7b/nursing-Care-Supplies.jpg",
    "Enteral Feeding Tubes":
      "https://i.ibb.co.com/SbYh857/enteral-Feeding.webp",
    "Skin Biologics": "https://i.ibb.co.com/Pzw14wNN/skin-Biologistic.jpg",
    "Advanced Wound Care":
      "https://i.ibb.co.com/mVH5tzvg/advanced-Wound-Care.jpg",
  };
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
          <div className="max-w-xl animate-fade-in">
            ...
            <p className="text-xl text-gray-50 mb-8">
              Quality medical equipment and supplies for healthcare
              professionals, hospitals, and clinics. Order with confidence from
              our curated selection of certified products.
            </p>
              ...
              {!user && (
                <Link
                  ...
                  className="px-6 py-3 bg-white text-secondary font-semibold rounded-lg border-2 border-white
                           hover:bg-gray-100 transition-all duration-200 text-center inline-flex items-center justify-center"
                >
                  Create Account
                </Link>
              )}
