  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          { label: 'Total Revenue', value: `$${totalSales.toFixed(2)}`, icon: DollarSign, color: 'text-green-600', bg: 'bg-green-50' },
          { label: 'Net Earnings', value: `$${(totalSales * (1 - commissionRate / 100)).toFixed(2)}`, icon: TrendingUp, color: 'text-blue-600', bg: 'bg-blue-50' },
          { label: 'Total Orders', value: monthlyRevenue.reduce((s, m) => s + m.orders, 0) || '—', icon: ShoppingBag, color: 'text-purple-600', bg: 'bg-purple-50' },
          { label: 'Active Products', value: vendorProducts.length, icon: Package, color: 'text-orange-600', bg: 'bg-orange-50' },
        ].map((kpi, i) => (
